...
namespace Microsoft.Data.Entity.Design.VisualStudio.ModelWizard.Engine
{
    ...
    // </summary>
    public class MyModelBuilderSettings
    {
        #region Constructors

        public MyModelBuilderSettings()
        {
        ...
        public string _designTimeConnectionString { get; set; }
        public string _appConfigConnectionString { get; set; }
        public string _appConfigConnectionPropertyName { get; set; }
        public string _designTimeProviderInvariantName { get; set; }
        public string _runtimeProviderInvariantName { get; set; }
        public string _modelNamespace { get; set; }
        ...
        public bool SaveConnectionStringInAppConfig { get; set; }

        public string AppConfigConnectionPropertyName
        {
